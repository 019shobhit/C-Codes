// Write a Program to  transpose of the matrix entered by the user in another matrix.
#include <stdio.h>
...
void trans_matrix(int row, int col, int arr[row][col],int arr2[row][col])
{
    int sum = 0;
    for (int i = 0; i < row; i++)
    {
